    ...
    <div className="about-wrap">
      ...
      <section className="about-values">
        ...
        <div className="about-grid">
          <div className="value-card"><div className="icon">🎯</div><h3>Focused Lessons</h3><p>Each topic in less than 12 minutes, explained with examples.</p></div>
          <div className="value-card"><div className="icon">📒</div><h3>Printable Notes</h3><p>PDF notes with formulas, summaries, and practice quizzes.</p></div>
          <div className="value-card"><div className="icon">💬</div><h3>Ask Any Doubt</h3><p>Subject experts usually reply within 6–12 hours.</p></div>
          <div className="value-card"><div className="icon">📈</div><h3>Exam Aligned</h3><p>Coverage and revision plans aligned with CBSE/ICSE/State board syllabi.</p></div>
        </div>
      </section>
